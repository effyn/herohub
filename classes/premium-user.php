...
class PremiumUser extends User
{
     ...
     * @param array $_heroes
     */
    public function __construct($platform, $email, $passhash, $tag, $region, $timezone, $micPref, $_heroes)
    {
        parent::__construct($platform, $email, $passhash, $tag, $region, $timezone, $micPref);
